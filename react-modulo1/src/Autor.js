...
class FormularioAutor extends Component {
    ...
    enviaForm(evento) {
        ...
        success: function(novaListagem){
            ...
            this.setState({nome:'',email:'',senha:''}); //limpa os campos quando salva a informação
        }.bind(this),
...
export default class AutorBox extends Component {
    ...
    componentDidMount() {
        ...
        PubSub.subscribe('atualiza-lista-autores',function(topico,novaLista){ //subscribe utilizado para ser notificado quando houver mudança
